...
<html>
  ...
  <body id="top" class="thebg" >
	    ...
	    <div>
			...
			<div class="left">
				<ul class="bcrumbs">
					...
					<li><a href="#">美国</a></li>
					<li>/</li>					
					<li><a href="#" class="active">纽约</a></li>					
				</ul>				
			</div>
				...
				<div class="itemscontainer offset-1">
					...
					<div class="col-md-4">
						...
						<div class="itemlabel2">
							<div class="labelright">
								<img src="resourse/images/filter-rating-5.png" width="60" alt=""/><br/><br/><br/>
								<img src="resourse/images/user-rating-5.png" width="60" alt=""/><br/>
								<span class="size11 grey">18 人浏览</span><br/><br/>
								<span class="green size18"><b>36.00RMB</b></span><br/>
								<span class="size11 grey">平均每晚</span><br/><br/><br/>
								<button class="bookbtn mt1">预订</button>		
							</div>
							<div class="labelleft">			
								<b>郑州御玺国际酒店</b><br/><br/><br/>
								<p class="grey">御玺国际酒店由河南御玺福国集团投资兴建的一家国际五星级标准的酒店酒店拥有140间豪华客房和套房，均呈现开阔优雅的空间、独特且国际化的时尚品质。<br/><br/>
								酒店拥有美食街、豪华包房和多功能宴会厅，令客人无须离店即可尽享人间美食。风格时尚的高楼层餐厅不仅可以让您享受迷人的城市景色还是您放松休闲的完美场所。</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						...
						<div class="itemlabel2">
							...
							<div class="labelleft">			
								<b>河南永和铂爵国际酒店</b><br/><br/><br/>
								<p class="grey">河南永和铂爵国际酒店是一家位于郑东新区CBD的白金五星级酒店，紧邻省政府，<br/><br/>
								毗邻郑州国际会展中心、河南省艺术中心，地理位置得天独厚，交通四通八达。</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						...
						<div class="itemlabel2">
							...
							<div class="labelleft">			
								<b>郑州悦莱时尚酒店</b><br/><br/><br/>
								<p class="grey">郑州悦莱时尚酒店是悦莱酒店管理有限公司旗下推出的概念型时尚酒店，主体建筑七层，<br/><br/>
								拥有时尚大床房、商务双标房和商务套房等各类房型130余间，还有大、中、小三类会议室，可同时容纳数百人的会议。</p>
							</div>
						</div>				
					</div>
					...
					<div class="col-md-4">
						...
						<div class="itemlabel2">
							...
							<div class="labelleft">			
								<b>郑州南北公馆(会展中心店)</b><br/><br/><br/>
								<p class="grey">南北公馆位于郑州市金水东路与黄河南路交汇处，紧邻地铁一号线及公交站，东依省政府和高铁东站，西靠曼哈顿金融广场和楷林国际大厦，<br/><br/>
								南邻机场高速，北面毗邻CBD核心商务区，距国际会展中心仅数步之遥，四周各大银行和公司总部林立，酒店交通便利，位置得天独厚。</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
    ...
    <!-- Counter -->	
    <script src="resourse/assets/js/js-list3.js"></script>	
