...
<html>
  <head>
	...
	<!-- PIECHART -->
	<link rel="stylesheet" type="text/css" href="resourse/assets/css/jquery.easy-pie-chart.css">	
			...
			<div class="container offset-3">
			  ...
			  <div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
				  ...
				  <li style="display:${user.uname==null?"none":''}"><a href="userUI">我的信息</a></li>
		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-12 pagecontainer2 offset-0">
				...
				<div class="hpadding50c">
					...
					在线旅行社，作为一个全球领先的在线旅游公司,<br/>
					我们可以很容易地计划你的下一个商务或休闲旅行
					</p>
					<br/>
					<div class="line3"></div>
					<br/>
					...
					<div class="col-md-4 cpdd02">
						<div class="opensans size18 grey">
							...
							艺龙旅行网 (NASDAQ: LONG)是中国领先的在线住宿服务提供商之一，致力于为消费者打造专注专业、物超所值、智能便捷的住宿预订平台。通过手机和平板客户端、手机艺龙网（m.eLong.com）和PC电脑网站（eLong.com）、24小时预订热线（4009-333-333），为消费者提供酒店、公寓、客栈、机票及火车票等预订服务。 
							<br/><br/>
							

							<span class="lato dark bold">特性</span><br/>
					...
					<span class="lato size18 dark bold">人员介绍</span><br/><br/>
					...
					<div class="col-md-4">
						<div class="opensans grey2">
							<span class="gcircle">1</span><span class="lato size18 dark mt6 ml10"><b>公司团队</b></span><br/><br/>
					...
					<div class="col-md-4">
						...
						<span class="gcircle">2</span><span class="lato size18 dark mt6 ml10"><b>我们的企业理念</b></span><br/><br/>
					...
					<div class="col-md-4">
						...
						<p class="opensans grey2">
						<span class="gcircle">3</span><span class="lato size18 dark mt6 ml10"><b>公司愿景</b></span><br/><br/>
