					...
					<div class="tab-content5">
						...
						<div class="tab-pane cpadding40 active" id="profile">
							...
							<ul class="d-status">
								<li class="popwidth2"><a href="#" id="notifications"
									data-content="No new messages...">Notifications<span
										class="d-not">0</span></a></li>
								<li><a href="#" id="messages"
									data-content="
							<div class='msgbox offset-0'>
								<img src='resourse/images/dash/avatar3.jpg' alt='' width='30' class='left margright10 roundav'/>
							...
							<div class='msgbox2 offset-0'>
								<img src='resourse/images/dash/no-avatar.jpg' alt='' width='30' class='left margright10 roundav'/>
							...
							<div class='msgbox offset-0'>
								<img src='resourse/images/dash/avatar2.jpg' alt='' width='30' class='left margright10 roundav'/>
							...
							"
									data-original-title="<span class='dark bold'>Notifications</span>">Messages<span
										class="d-mes active">3</span></a></li>


								<li class="popwidth"><a href="#" id="tasks"
									data-content="
								<ul class='checklist3'>
								...
								<div class='clearfix'></div>
							">Tasks<span
										class="d-tas active">6</span></a></li>
							</ul>
							<div class="line2"></div>
							...
							<div class="alert alert-warning fade in margtop20">
								<button aria-hidden="true" data-dismiss="alert" class="close"
									type="button">×</button>
								<strong>Notification!</strong> Best check yo self, you're not
								looking too good.
							</div>
							...
							<br /> <span class="lato size18">Traffic</span> <br /> <br />



							<ul class="visitsboolets mt10 left margleft15">
								<li class="size14 mt-3 dark">Visits</li>
								<li><span class="blue"></span><a href="#">Search
										Traffic</a></li>
								<li><span class="red"></span><a href="#">Referral
										Traffic</a></li>
								<li><span class="green"></span><a href="#">Direct
										Traffic</a></li>
								<li><span class="yellow"></span><a href="#">Campaigns</a></li>
								<li><span class="grey"></span><a href="#">Today’s
										traffic</a></li>
							</ul>
							...
							<div class="bgstats">
								<div class="visitsnr">
									4,000<br /> 3,000<br /> 2,000<br /> 1,000
								</div>
								<ul class="mdates">
									<li>Aug 15</li>
									<li>Aug 22</li>
							...
							<br />
							<div class="clearfix"></div>
							<br /> <span class="lato size18">Today’s visits</span>
							<div class="clearfix"></div>
							...
							<div class="col-md-6 offset-0">
								<span class="lato size18">8,173 people visited this site</span><br />
								<br />
							...
							<div class="col-md-12 offset-0">
								<div class="col-md-6 offset-0">
									...
									<ul class="nav navigation-tabs2">
										<li class="active"><a href="#tab-newtopic"
											data-toggle="tab">Topics <span class="badge cbhide">6</span></a></li>
										<li><a href="#tab-comments" data-toggle="tab">Comments
												<span class="badge cbhide">1</span>
										</a></li>
										<li><a href="#tab-blogcomments" data-toggle="tab">Blog
												<span class="badge cbhide">2</span>
										</a></li>
									</ul>
										...
										<div class="tab-pane active" id="tab-newtopic">
											<div class="table-responsive">
													...
													<table class="tablehover">
														<tr>
															...
															<td><span class="dark">Load Container Content</span><br />
																...
																tempor ante eu, rhoncus ligula.</td>
													...
													<table class="tablehover">
														<tr>
															...
															<td><span class="dark">Customize Twitter api
																...
																Donec et tortor ullamcorper, tempor ante eu, rhoncus
																ligula.</td>
															<td class="cwth"><input type="checkbox" class=""></td>
														</tr>
													</table>
													...
													<table class="tablehover">
														<tr>
															...
															<td><span class="dark">Changing top Nav text
																...
																tortor ullamcorper, tempor ante eu, rhoncus ligula.</td>
															<td class="cwth"><input type="checkbox" class=""></td>
														</tr>
													</table>
													<div class="line3"></div>
												...
												<div class="input-group">
													<input type="text" class="form-control cfctrl"> <span
								...
								<div class="col-md-6 cpadding01">
									...
									<span class="lato size13 grey">Disk space usage: 1,746.5
										/ 50,000 MB</span> <br /> <br /> <br />
									<div class="progress2 progress-striped">
										<div class="progress-bar progress-bar-success"
											role="progressbar" aria-valuenow="55" aria-valuemin="0"
											aria-valuemax="100" style="width: 55%"></div>
									</div>
									<span class="lato size13 grey">Monthly Bandwidth
										Transfer: 14,706.1 / 30.000</span> <br /> <br /> <br />
									<div class="progress2 progress-striped">
