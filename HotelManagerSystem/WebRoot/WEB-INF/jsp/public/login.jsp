		...
		<div class="login-wrap">
			...
			<div class="login-c1">
				...
				<div class="cpadding50">
					...
					<br/>
					<input type="password" id="upwd" name="upwd" class="form-control logpadding" placeholder="密码">
				</div>
			</div>
			<div class="login-c2">
			...
			<div class="login-c3">
				<div class="left"><a href="index.jsp" class="whitelink"><span></span>网站主页</a></div>
				<div class="right"><a href="#" class="whitelink">忘记密码?</a></div>
			</div>			
		</div>
		<!-- End of Login Wrap  -->
	</form>
